...
export const ActiveContext = React.createContext( {activeIndex: 0, handleUpdateIndex: function() {}} );
  ...
  render() {
    return (
      <div>
        ...
        <ActiveContext.Provider value={{activeIndex: this.state.activeIndex, handleUpdateIndex: this.handleClick}}>
          <List
